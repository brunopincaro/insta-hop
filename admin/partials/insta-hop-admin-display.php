 ...
 *
 * @package    Insta_Hop
 * @subpackage Insta_Hop/admin/partials
 */
?>
...
/**
*
* admin/partials/insta-hop-admin-display.php - Don't add this comment
*
**/
?>
...
<div class="wrap">
    ...
    <h2 class="nav-tab-wrapper">Authenticate</h2>
    ...
    <form method="post" name="cleanup_options" action="options.php">
        ...
        <fieldset>
            ...
            <div id="upload_logo_preview" class="insta_hop-upload-preview <?php if(empty($login_logo_id)) echo 'hidden'?>">
                <img src="<?php echo $login_logo_url; ?>" />
                <button id="insta_hop-delete_logo_button" class="insta_hop-delete-image">X</button>
            </div>
        </fieldset>
        <!-- login background color-->
        <fieldset class="insta_hop-admin-colors">
